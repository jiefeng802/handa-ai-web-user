...
export const useSync = () => {
  ...
  const providerIconUrls: Record<Provider, string> = {
    Google:
      "https://handa-cms.s3.eu-west-3.amazonaws.com/gdrive_8316d080fd.png",
    Azure:
      "https://handa-cms.s3.eu-west-3.amazonaws.com/sharepoint_8c41cfdb09.png",
    DropBox:
      "https://handa-cms.s3.eu-west-3.amazonaws.com/dropbox_dce4f3d753.png",
    GitHub:
      "https://handa-cms.s3.eu-west-3.amazonaws.com/dropbox_dce4f3d753.png",
  };
